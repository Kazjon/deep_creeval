...
./startmongo.sh
cd deep_creeval
python deep_creeval.py ebird_top10_2008_2012 -m f train_exp --epochs 5 --sample_limit 0 --exp_name exp_5yr_monthly_5epochs  --pretrain_start 2008 --pretrain_stop 2009 --train_stop 2013 --time_slice 0.0833
kill -9 `pidof mongod`
